...
export default function Home() {
  ...
  const changeBackground = () => {
    ...
    if (backgroundImage === "/without-light.jpg") {
      setBackgroundImage("/light.jpg");
    } else {
      setBackgroundImage("/without-light.jpg");
    }
  };
  ...
  //     setBannerImage(prev => (prev === "1" ? "2" : "1"));
  //   }, 5000);
  ...
  const tweetIntent = {
    url: "",
    hashtags: "solana,immutablelegends",
    text: "Legends are my next pfp",
    via: "Immulegends",
    related: "",
    in_reply_to: ""
  }
  return (
    <React.Fragment>
      ...
      <section className="banner-home" >
        <img className="banner-img" src={`/img/immu_banner${bannerImage}.${bannerImage == "1" ? 'webp' : 'jpg'}`} alt="" onClick={changeBackground} />
      </section>
        ...
        <div className="Wrapper block">
          <div className="RankContainer container block">
            <div className="left-side">
              ...
              <a target="_blank" href={`https://twitter.com/intent/tweet?text=${tweetIntent.text}&url=${tweetIntent.url}&via=${tweetIntent.via}&related=${tweetIntent.related}&in_reply_to=${tweetIntent.in_reply_to}&hashtags=${tweetIntent.hashtags}`}>
              <button className="twitter-btn">
                ...
                <span className="text2">Cool</span>
              </button>
              </a>
